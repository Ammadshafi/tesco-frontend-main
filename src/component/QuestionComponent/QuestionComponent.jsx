    ...
    <Box className="questionnaries-container">
      ...
      <Box className="questionnaries-main">
        ...
        >
          ...
          <Box className="edit-container" textTransform={'capitalize'} style={{cursor:"pointer"}}>
        ...
        <Box className="questionnaries-details-container">
         <textarea style={{textTransform:'capitalize'}} disabled={editState}  className="textArea"/>
        </Box>
      </Box>
    </Box>
  );
